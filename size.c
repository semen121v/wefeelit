...
/*   Updated: 2019/02/16 19:26:17 by fshade           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "fillit.h"

void static	creat_size3(t_mas *ptr, t_coordinates *dot, int i, int j)
{	
	int		m;
...
void static	creat_size2(t_mas *ptr, t_coordinates *dot, int i, int j)
{
	int		m;
